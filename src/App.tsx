...
function App() {
  ...
  const calculateFare = useCallback((distanceKm: number, waitingMinutes: number, sorianaBonus: boolean = false) => {
    ...
    if (selectedTripType.fixedPrice || (selectedTripType.id === 'cristoRey' && selectedSubTrip)) {
      ...
      return baseCost + waitingCost + sorianaExtraFee + petExtraFee + servicioEspecialFee;
    }
    ...
    return fare + (waitingMinutes * RATES.waitingRate) + sorianaExtraFee + petExtraFee + servicioEspecialFee;
    };

    return baseCostCalculation() + costoAcumulado;
  }, [selectedTripType, selectedSubTrip, petConfig, servicioEspecialConfig, costoAcumulado]);
                        ...
                        return (
                          <>
                            <div className="flex justify-between items-center text-sm">
                              <span className="text-gray-300">Tarifa por distancia:</span>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-50 p-4">
            <div className="bg-gradient-to-br from-gray-900 to-black border border-yellow-400 rounded-xl p-6 max-w-sm w-full shadow-2xl">
              ...
              <div className="space-y-3">
                <button
                  onClick={() => {
                    setCostoAcumulado(prev => prev + tripData.cost);
                    setTripData(prev => ({
                      ...prev,
                      distance: 0,
                      rawDistance: 0,
